...
bool sensor_registry_add(const uint8_t *mac, uint8_t type, uint16_t slot, const char *name, uint8_t client_chip = HW_CHIP_UNKNOWN, uint8_t radio_type = RADIO_ESPNOW);
