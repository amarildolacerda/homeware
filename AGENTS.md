...
- `bridge_python` - projeto de integração com Homeassitant
...
14. Toda implementação adicionada no bridge C (main/) deve ser replicada no bridge Python (bridge_python/ - submodule) e vice-versa
